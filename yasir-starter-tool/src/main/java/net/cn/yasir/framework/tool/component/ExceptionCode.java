...
public class ExceptionCode {
    ...
    public static final ReturnCode PARAM_INVAILD = new ReturnCode(1005, "参数校验失败[{0}]");

    public static final ReturnCode RECORD_EXIST = new ReturnCode(1006, "{0}记录已存在");

    public static final ReturnCode RECORD_NOT_EXIST = new ReturnCode(1007, "{0}记录不存在");
